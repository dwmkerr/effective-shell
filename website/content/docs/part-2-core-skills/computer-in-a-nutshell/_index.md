...
- Quickly enter commands, see the history of commands and quickly restructure commands (see [Chapter 8 - Fly on the Command Line]({{< relref "/docs/part-3-getting-faster/fly-on-the-command-line" >}}))
