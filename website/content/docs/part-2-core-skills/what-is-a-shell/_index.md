...
- Navigate through the file system, moving from folder to folder (see [Chapter 1- Navigating Your System]({{< relref "/docs/part-1-getting-started/navigating-your-system" >}})), which makes it easier for an operator to navigate the file system
