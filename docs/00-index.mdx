...
If you are using a computer, you have enough to get started! In [_Chapter 1 - Setting Up Your Shell Environment_](./01-transitioning-to-the-shell/01-getting-started/00-index.md) you'll learn how to setup your shell in Windows, Linux or MacOS. 
