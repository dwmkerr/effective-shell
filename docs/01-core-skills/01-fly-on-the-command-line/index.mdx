...
Below is a quick reference showing the key shortcuts covered in this chapter — you might find it helpful to download [navigating-the-command-line.png](./images/command-line.png) and set it as a wallpaper:
