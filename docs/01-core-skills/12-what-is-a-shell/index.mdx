...
- Quickly enter commands, see the history of commands and quickly restructure commands (see [Chapter 8 - Fly on the Command Line](../../01-core-skills/08-fly-on-the-command-line/index.mdx))
