...
| Keystrokes           | Output                |
|----------------------|-----------------------|
|                      | <pre><Caret>V</Caret>im Cheatsheet<br /><br />## Vim Motions<br /><br />Vim motions are commands used to move the cursor. Essential motions are:</pre> | 

TODO check the practical vim book for this one.
