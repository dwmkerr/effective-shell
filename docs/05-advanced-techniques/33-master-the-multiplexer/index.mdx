...
Tmux follows a very standard Unix-style configuration pattern - a dotfile is used to configure the program. If you are not familiar with dotifles, check [Chapter 26 - Managing Your Dotfiles](../../05-building-your-toolkit/26-managing-your-dotfiles/index.mdx) - this chapter also goes into detail on how you can version control and save your dotfiles as well as share them across many machines easily.
