...
A lot of these expansions are covered in detail in [Chapter 19 - Variables, Reading Input, and Mathematics](../../03-shell-scripting/19-variables-reading-input-and-mathematics/index.mdx) but I have included each of the available expansions here for reference.
...
For suggestions on alternative ways to manipulate text check [Chapter 15 - Slice and Dice Text](../../02-manipulating-text/15-slice-and-dice-text/index.mdx) or [Chapter 16 - Advanced Text Manipulation with Sed](../../02-manipulating-text/16-advanced-text-manipulation/index.mdx).
...
You can see more examples of how parameter expansion works, and in particular how to use parameter expansion with the parameters to functions or scripts in [Chapter 19 - Variables, Reading Input, and Mathematics](../../03-shell-scripting/19-variables-reading-input-and-mathematics/index.mdx).
...
Arithmetic expansion is covered in detail in [Chapter 19 - Variables, Reading Input, and Mathematics](../../03-shell-scripting/19-variables-reading-input-and-mathematics/index.mdx).
