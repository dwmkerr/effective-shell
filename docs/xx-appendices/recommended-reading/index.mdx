...
- [The Changelog - Warp wants to be the terminal of the future](https://changelog.com/podcast/487)
- [The Changelog - The terminal as a platform](https://changelog.com/podcast/511)
- [GitHub The ReadME Project - Building the future of the command line](https://github.com/readme/featured/future-of-the-command-line)
...
- [The Changelog - Efficient Linux at the CLI](https://changelog.com/podcast/547)
