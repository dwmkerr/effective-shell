---
title: 'Appendix C: Perspectives'
slug: '/appendices/perspectives/'
---

This appendix contains "interludes"—discussion pieces that give context and background about the world of the shell, Linux and modern computing, rather than teaching specific skills.

## The Renaissance of the Shell

In this interlude we'll look at just why the shell is experiencing something of a renaissance in the modern age of IT.
