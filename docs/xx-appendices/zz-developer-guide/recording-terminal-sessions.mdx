...
The [`asciinema`](https://asciinema.org) tool can record the output of terminal sessions. You can see the results in action in pages like [Chapter 33 - Master the Multiplexer](../../05-advanced-techniques/33-master-the-multiplexer/index.mdx).
