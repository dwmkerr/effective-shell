...
In [Chapter 19 - Variables, Reading Input, and Mathematics](../../part-4-shell-scripting/variables-reading-input-and-mathematics) we saw how to create arrays. We can easily loop through the items in an array with a for loop. Here's an example:
...
If you are not familiar with the `find` command, check [Chapter 11 - Finding Files](../../part-2-core-skills/finding-files).
...
Note that we've used the string-length parameter expansion function to get the length of the `random_number_` variable here. If this is not familiar, check [Chapter 19 - Variables, Reading Input, and Mathematics](../../part-4-shell-scripting/variables-reading-input-and-mathematics).
...
The reason for this has been touched on in [Chapter 19 - Variables, Reading Input, and Mathematics](../../part-4-shell-scripting/variables-reading-input-and-mathematics) and also partly in this chapter.
...
In the second example, the loop iterates over the `"$sentence"` variable. Note that this variable _is_ quoted. As we saw in [Chapter 19](../../part-4-shell-scripting/variables-reading-input-and-mathematics) quoting a variable means that it is treated literally, expect for parameter expansion.
...
[^1]: If we had put quotes around the wildcard text it would _not_ be expanded - check the section on 'Quoting' in [Chapter 19 - Variables, Reading Input, and Mathematics](../../part-4-shell-scripting/variables-reading-input-and-mathematics) if you need a refresher on this.
[^2]: ANSI C Quoting is described in the 'Quoting' section in [Chapter 19 - Variables, Reading Input, and Mathematics](../../part-4-shell-scripting/variables-reading-input-and-mathematics)
