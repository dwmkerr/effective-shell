...
* [Section One - Transitioning from The Graphical User Interface (GUI) to the Shell](#section-one---transitioning-from-the-graphical-user-interface-gui-to-the-shell)
    * [Chapter 1.1 - Navigating your System](#chapter-11---navigating-your-system)
    * [Chapter 1.2 - Organising Files](#chapter-12---organising-files)
    * [Chapter 1.3 - More on Files](#chapter-13---more-on-files)
    * [Chapter 1.4 - Become a Clipboard Gymnast](#chapter-14---become-a-clipboard-gymnast)
    * [Chapter 1.5 - Getting Help](#chapter-15---getting-help)
...
* [Section Two - Core Skills](#section-two---core-skills)
    * [Chapter 2.1 - Navigating the Command-line](#chapter-21---navigating-the-command-line)
    * [Chapter 2.2 - Job Control](#chapter-22---job-control)
    * [Chapter 2.3 - Thinking in Pipelines](#chapter-23---thinking-in-pipelines)
    * [Chapter 2.4 - The Subtleties of Shell Commands](#chapter-24---the-subtleties-of-shell-commands)
    * [Chapter 2.5 - The Secure Shell](#chapter-25---the-secure-shell)
...
* [Section Three - Manipulating Text & Streams](#section-three---manipulating-text--streams)
    * [Chapter 3.1 - Slice and Dice with Cut and Rev](#chapter-31---slice-and-dice-with-cut-and-rev)
    * [Chapter 3.2 - Getting to Grips with Grep](#chapter-32---getting-to-grips-with-grep)
    * [Chapter 3.3 - Advanced Text Manipulation with Sed and Awk](#chapter-33---advanced-text-manipulation-with-sed-and-awk)
    * [Chapter 3.4 - Clever Commands with Xargs and Quick Scripts](#chapter-34---clever-commands-with-xargs-and-quick-scripts)
    * [Chapter 3.5 - Bash Text Tricks - Regexes and String Manipulation](#chapter-35---bash-text-tricks---regexes-and-string-manipulation)
    * [Chapter 3.6 -- The Missing Tools: jq, yq and xq](#chapter-36----the-missing-tools-jq-yq-and-xq)
* [Section Four - Building Your Toolkit](#section-four---building-your-toolkit)
    * [Chapter 4.1 - Configuring the Shell](#chapter-41---configuring-the-shell)
    * [Chapter 4.2 - Customising your Command Prompt](#chapter-42---customising-your-command-prompt)
    * [Chapter 4.3 - Managing Your Dotfiles](#chapter-43---managing-your-dotfiles)
    * [Chapter 4.4 - Creating Shell Scripts and Understanding Shebangs](#chapter-44---creating-shell-scripts-and-understanding-shebangs)
    * [Chapter 4.5 - Getting to Grips with Git](#chapter-45---getting-to-grips-with-git)
...
* [Section Five - Shell Scripting](#section-five---shell-scripting)
    * [Chapter 5.1 - Looping over files and folders](#chapter-51---looping-over-files-and-folders)
    * [Chapter 5.2 - Basic Maths](#chapter-52---basic-maths)
    * [Chapter 5.3 - Understanding Heredocs](#chapter-53---understanding-heredocs)
    * [Chapter 5.4 - How to avoid scripting!](#chapter-54---how-to-avoid-scripting)
* [Interlude - TBC](#interlude---tbc)
* [Section Six - Advanced Techniques](#section-six---advanced-techniques)
    * [Chapter 6.1 - Managing Multiple Programming Languages with Make](#chapter-61---managing-multiple-programming-languages-with-make)
    * [Chapter 6.2 - The Power of Terminal Editors](#chapter-62---the-power-of-terminal-editors)
    * [Chapter 6.3 - The Multiplexer](#chapter-63---the-multiplexer)
    * [Chapter 6.4 - Writing Tools that Follow The Unix Philosophy](#chapter-64---writing-tools-that-follow-the-unix-philosophy)
...
For the newcomer, we'll take a look at what a shell is, how to open it, and how to configure your computer to follow along with the examples. We'll also look at also describes *why* you might use a shell in this day and age.
...
#### Chapter 1.1 - Navigating your System
...
#### Chapter 1.4 - Become a Clipboard Gymnast
...
#### Chapter 2.1 - Navigating the Command-line
...
#### Chapter 2.3 - Thinking in Pipelines
...
#### Chapter 2.4 - The Subtleties of Shell Commands
...
#### Chapter 3.1 - Slice and Dice with Cut and Rev
...
#### Chapter 3.2 - Getting to Grips with Grep
...
#### Chapter 3.3 - Advanced Text Manipulation with Sed and Awk
...
#### Chapter 3.4 - Clever Commands with Xargs and Quick Scripts
...
#### Chapter 3.5 - Bash Text Tricks - Regexes and String Manipulation
...
#### Chapter 3.6 -- The Missing Tools: jq, yq and xq
...
#### Chapter 4.1 - Configuring the Shell
...
#### Chapter 4.2 - Customising your Command Prompt
...
#### Chapter 4.3 - Managing Your Dotfiles
...
#### Chapter 4.4 - Creating Shell Scripts and Understanding Shebangs
...
#### Chapter 4.5 - Getting to Grips with Git
...
#### Chapter 5.1 - Looping over files and folders
...
#### Chapter 5.3 - Understanding Heredocs
...
#### Chapter 5.4 - How to avoid scripting!
...
#### Chapter 6.1 - Managing Multiple Programming Languages with Make
...
#### Chapter 6.2 - The Power of Terminal Editors
...
#### Chapter 6.4 - Writing Tools that Follow The Unix Philosophy
